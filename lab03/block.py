...
def padding(img_array, block_size=8):
...
def making_blocks(img_array, block_size=8):
    height, width = img_array.shape
    blocks = []
...
img_array = load_image("plain.bmp")

padded = padding(img_array)
height, width = padded.shape
blocks = making_blocks(padded)
...
save_image(ecb_array, "ecb_crypto.bmp")
...
save_image(cbc_array, "cbc_crypto.bmp")